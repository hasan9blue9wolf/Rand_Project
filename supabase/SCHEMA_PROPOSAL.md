# Haya Trips Supabase Schema Proposal
...
### `travel_preferences`
- One row per user.
- Stores preference signals used by Haya and future recommendation flows.
...
### `ai_chat_threads`
- Conversation containers for Haya chat sessions.
- Stores locale, preview text, and recency metadata.

### `ai_chat_messages`
- Message log for each Haya thread.
...
- Initial migration: [20260327090000_initial_hayatrips.sql](/home/bluewolf/Desktop/Rand_Project/supabase/migrations/20260327090000_initial_hayatrips.sql)
