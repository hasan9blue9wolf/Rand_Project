...
- Kept the investor build on `demo` mode with mock Haya behavior and no real payment processing.
...
- Removed a dead-end Haya mic interaction by turning it into a premium demo shortcut and disabling it when unavailable in [chat-input.tsx](/home/bluewolf/Desktop/Rand_Project/features/heia/components/chat-input.tsx).
...
- Home, Search, Package Details, Haya, Trips, Offers, and Profile remain usable
