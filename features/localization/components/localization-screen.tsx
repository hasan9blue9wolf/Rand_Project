...
export const LocalizationScreen = () => {
  ...
  const copy =
    language === "ar"
      ...
      : language === "fr"
        ? {
            currentTitle: "Présentation actuelle",
            heroBadge: "Expérience trilingue",
            heroBody:
              "Choisissez la langue qui pilote le ton, le formatage et le sens de lecture de l'expérience premium.",
            heroTitle: "Choix de la langue",
            previewTitle: "Aperçu du formatage",
            subtitle:
              "Choix de langue, aperçu du formatage et support RTL pour l'arabe.",
            supportTitle: "Ce qui change",
          ...
          <View style={{ gap: spacing.xs }}>
            ...
            <AppText variant="bodySmall">
              {locale.locale === "ar"
                ...
                : locale.locale === "fr"
                  ? "Une interface française claire avec une lecture de gauche à droite."
