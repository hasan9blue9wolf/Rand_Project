...
const destinationStories = {
  ...
  barcelona: {
    ...
    overview: {
      ar: "برشلونة في هيا تريبس تبدو مدينة أنيقة وسهلة. الثقافة قريبة، والإقامة مركزية، واليوم موزع بين النشاط والراحة.",
      en: "Barcelona in Haya Trips feels polished and easy. Culture stays close, the hotel stays central, and the day moves between energy and comfort.",
    },
    rhythm: {
      ar: [
        {
