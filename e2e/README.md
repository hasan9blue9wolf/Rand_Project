...
Haya Trips is being demoed as an Android APK, so the recommended E2E tool for the first production-grade pass is `Maestro`.
...
- Open Haya from the tab bar or Home banner.
...
- Home, Search Results, Package Details, Haya, and Auth all complete successfully
